...
public class UserBy{
    ...
    UserBy (String name, String zipCode, String country, String city, String street, String home, String flat, String phoneNumber, int users, float errors) {
    ...
    public static void addErrors (String name, String zipCode, String country, String city, String street, String home, String flat, String phoneNumber, int users, float errors) {
        int n = users;
        float m = errors;
        double k = Math.round(Math.random() * n * (m + 1));
        ...
        System.out.println(name + "; " + zipCode + "; " + country + "; " + city + ", " + street + ", х. " + home + ", кв. " + flat + "; " + phoneNumber);
