...
public class User {
    ...
    public User (String name, String zipCode, String country, String city, String street, String home, String flat, String phoneNumber, int users, float errors) {
    ...
    public static void addErrors (String name, String zipCode, String country, String city, String street, String home, String flat, String phoneNumber, int users, float errors) {
        ...
        System.out.println(name + "; " + zipCode + "; " + country + "; c. " + city + ", " + street + ", h. " + home + ", fl. " + flat + "; " + phoneNumber);
